...
class Node(INode):
    def __init__(self, special_id, config, editor, canvas, x, y, control, text, theme, **kwargs):
        ...
        self.add_output_socket('', self.palette['vector1d'], self.width + 13, -self.height + 7)

        self.add_enter_socket('', self.palette['vector1d'], - 18, -self.height + 7)
        ...
        self.events_reactions['Vector Updated'] = lambda event: self.vector_updated(event)
    ...
    def execute(self):
        ...
        self.event_bus.raise_event(Event('Vector Updated', {'name': self.vector_name, 'value': arguments[''], 'tab': self.editor}))
